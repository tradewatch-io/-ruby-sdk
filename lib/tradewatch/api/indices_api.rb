  ...
  class IndicesApi
    ...
    def getQuote_with_http_info(symbol, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IndicesApi.getQuote ...'
      end
      # verify the required parameter 'symbol' is set
      if @api_client.config.client_side_validation && symbol.nil?
        fail ArgumentError, "Missing the required parameter 'symbol' when calling IndicesApi.getQuote"
      end
      # resource path
      local_var_path = '/indices/symbols/{symbol}'.sub('{' + 'symbol' + '}', CGI.escape(symbol.to_s))
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IndicesApi#getQuote\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def getSymbols_with_http_info(mode, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IndicesApi.getSymbols ...'
      end
      # verify the required parameter 'mode' is set
      if @api_client.config.client_side_validation && mode.nil?
        fail ArgumentError, "Missing the required parameter 'mode' when calling IndicesApi.getSymbols"
      end
      if @api_client.config.client_side_validation && !opts[:'page'].nil? && opts[:'page'] < 1
        fail ArgumentError, 'invalid value for "opts[:"page"]" when calling IndicesApi.getSymbols, must be greater than or equal to 1.'
      end

      # resource path
      local_var_path = '/indices/symbols'
      ...
      new_options = opts.merge(
        :operation => :"IndicesApi.getSymbols",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IndicesApi#getSymbols\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
